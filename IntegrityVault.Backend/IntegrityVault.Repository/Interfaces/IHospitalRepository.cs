...
namespace IntegrityVault.Repository.Interfaces
{
    ...
    public interface IHospitalRepository
    {
        ...
        Task<int> CreateHospitalAsync(CreateHospitalDTO createHospitalDTO, byte[] encryptedKey); // Method signature for creating a new hospital asynchronously. Accepts a CreateHospitalDTO and returns a boolean indicating success.
        Task<bool> UpdateHospitalAsync(int id, UpdateHospitalDTO updateHospitalDTO, byte[]? encryptedKey); // Updates an Hospital record identified by the given ID.
