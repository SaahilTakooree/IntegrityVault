...
export class UserService {
    ...
    private _apiUrl = 'https://localhost:7018/api/User';


    // Fetch the list of all users.
    getAllUsers() : Observable<(IAdmin | IDoctor | IExternalProvider | IPatient)[]> {
        return this._http.get<(IAdmin | IDoctor | IExternalProvider | IPatient)[]>(`${this._apiUrl}`).pipe();
    }
